<template>
    <footer class="govuk-footer" role="contentinfo">
        <div class="govuk-width-container" :class="computedContainerClasses">

            <div v-if="items" class="govuk-footer__navigation">
                <div v-for="(item, key) in items" :key="key" class="govuk-footer__section">
