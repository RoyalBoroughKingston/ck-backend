<template>
  <gov-table>
    <template slot="body">
      ...
      <gov-table-row v-if="location.has_induction_loop">
      ...
      <gov-table-row v-if="location.has_wheelchair_access">
